...
interface ContentWorkflowDisplayProps {
  content: {
    seoTitles: string[];
    content: string;
    imageUrl: string;
...
export const ContentWorkflowDisplay = ({ content }: ContentWorkflowDisplayProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <h4 className="font-medium mb-4">Image générée</h4>
